...
@section('content')
                ...
                <tbody>
                    @forelse($riwayat as $item)
                        @php
                            ...
                            // kalau remedial dan sekarang lulus
    ...
    <div class="nav-bottom">
        ...
        <a href="/bab2/tujuan-pembelajaran-bab2" class="nav-btn nav-next">
            Halaman Selanjutnya
        </a>
    </div>
    ...
    <script>
        ...
        function mulaiKuis() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "/bab1/kuis-bab1";
                }
            });
        }
        ...
        function openReview(id) {
            ...
            fetch(`/review-jawaban/${id}`)
                ...
                .then(data => {
                    ...
                    if (data.length === 0) {
                        ...
                        data.forEach((item, index) => {
                            ...
                            let opsi = JSON.parse(item.pilgan_opsi || "{}");
                ...
                .catch(() => {
                    document.getElementById("isiReview").innerHTML = "Gagal load data";
                });
        }
