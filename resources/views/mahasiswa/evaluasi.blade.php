...
@section('content')
        ...
        <div class="card-body-custom">
            ...
            <ul class="rule-list">
                <li><i class="bi bi-check-circle-fill"></i>
                    Evaluasi terdiri dari <strong>20 soal pilihan ganda</strong> untuk menguji pemahaman materi sebelumnya.
                </li>
                ...
                <li><i class="bi bi-check-circle-fill"></i>
                    Durasi pengerjaan adalah <strong>40 menit</strong>. Waktu ditampilkan di bagian kiri atas halaman.
                </li>
                ...
                <li><i class="bi bi-check-circle-fill"></i>
                    Gunakan tombol <strong>SELESAI</strong> untuk mengakhiri ujian.
                </li>

                <li><i class="bi bi-check-circle-fill"></i>
                    Jika waktu habis, ujian akan tertutup otomatis dan diarahkan ke halaman hasil.
                </li>

                <li><i class="bi bi-check-circle-fill"></i>
                    Keluar dari halaman saat ujian berlangsung akan menyebabkan semua jawaban hilang.
                </li>

                <li><i class="bi bi-check-circle-fill"></i>
                    Setiap peserta memiliki <b>maksimal 3 kali</b> kesempatan untuk mengerjakan evaluasi.
                </li>
            </ul>
                ...
                <tbody>
                    @forelse($riwayat as $item)
                        ...
                        @php
                            ...
                            $kkm = auth()->user()->kelas->kkm_evaluasi;
                        ...
                        <tr>
                            ...
                            <td>
                                @if($nilaiTampil >= auth()->user()->kelas->kkm_evaluasi)
    ...
    <div class="nav-bottom">
        <a href="/bab1/rangkuman-bab1" class="nav-btn nav-prev">
            Halaman Sebelumnya
        </a>
    </div>
    ...
    <script>
        function mulaiKuis() {
            ...
            const jumlahPercobaan = {{ $riwayat->count() }};

            @php

                $sudahLulus = $riwayat->contains(function ($item) use ($riwayat) {
                    ...
                    return $nilaiTampil >= $kkm;

                });

            @endphp

            const sudahLulus = {{ $sudahLulus ? 'true' : 'false' }};
            ...
            if (sudahLulus) {
                ...
                Swal.fire({
                    ...
                    text: 'Kamu sudah dinyatakan lulus evaluasi.'
                });

                return;
            }

            // kalau percobaan habis
            if (jumlahPercobaan >= 3) {

                Swal.fire({
                    icon: 'error',
                    title: 'Kesempatan Habis',
                    text: 'Kamu sudah menggunakan 3 kali kesempatan evaluasi.'
                });
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "/mulai-evaluasi";
                }
